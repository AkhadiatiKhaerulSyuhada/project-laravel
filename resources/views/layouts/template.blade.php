...
<head>
  ...
  <title>@yield('judul') - Asisten Praktikum </title>
...
<body>
  ...
  <footer id="footer" class="footer">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-5 col-md-12 footer-info">
            ...
            <p>Cari Asisten Praktikum Terbaikmu Disini.</p>
          ...
          <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
            <h4>Hubungi Kami</h4>
            <p>
              Jln.Prof Buya Hamka NO 59<br>
              Kota Tegal<br>
              Jawa Tengah <br><br>
              <strong>Phone:</strong>+6283898999105<br>
              <strong>Email:</strong>khaesyuuu@gmail.com<br>
            </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Asisten Terbaik</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
